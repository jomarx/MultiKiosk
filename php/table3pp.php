...
//	$sql = "SELECT * from mbreak_db";
		$sql = "SELECT task_db.ID,task_db.location,mech_db.FirstName,mech_db.LastName,mech_db.ShortName,cancel_db.recorded,cancel_db.taskID,task_db.ID,task_db.details,mbcode_db.details as det from cancel_db INNER JOIN mech_db ON mech_db.empID=cancel_db.mech INNER JOIN task_db ON task_db.ID=cancel_db.taskID INNER JOIN mbcode_db ON task_db.details=mbcode_db.id";
